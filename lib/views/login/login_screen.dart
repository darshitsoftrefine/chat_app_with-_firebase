...
class LoginScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text(ConstantStrings.loginText),
      ),
      body: SafeArea(
        ...
        child: SingleChildScrollView(
          child: Column(
            children: [
              ...
              const Text(ConstantStrings.loginText, style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold),),
              const SizedBox(height: 10,),
              ...
              GestureDetector(
                ...
                child: const Text(ConstantStrings.signInText, style: TextStyle(fontSize: 16),)),
                const SizedBox(height: 20,),
                            ...
                            children: [
                              Expanded(
                                child: ElevatedButton(onPressed: () async{
                                  ...
                                  child: const Text(ConstantStrings.loginText, style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold),),
                                ),
                              ),
                            ],
                          );
